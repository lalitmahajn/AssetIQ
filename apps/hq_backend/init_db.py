"""
Database initialization script for HQ backend.
...
def init_hq_db() -> None:
    """Initialize HQ database tables from SQLAlchemy models."""
    ...
    if not db_url:
        logger.error("HQ_DB_URL environment variable not set")
        sys.exit(1)

    logger.info("Connecting to HQ database...")
    ...
    logger.info("HQ database initialization complete!")
