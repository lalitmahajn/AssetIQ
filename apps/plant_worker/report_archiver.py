...
from common_core.vault_policy import get_vault_root, hot_days, archive_days, cold_enabled
...
def run_once() -> dict:
    ...
    cold = root / "cold"
    _ensure(hot); _ensure(archive); _ensure(cold)
    ...
    summary = {"ts_utc": now.isoformat(), "moved_hot_to_archive": moved_hot_to_archive, "moved_archive_to_cold": moved_archive_to_cold}
