...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_master_items_master_type_code"), "master_items", ["master_type_code"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column("site_code", sa.String(length=16), nullable=False),
        sa.Column(
            "master_type_code", sa.String(length=64), nullable=False, server_default="STOP_REASON"
        ),
    ...
    op.create_index(
        op.f("ix_reason_suggestions_master_type_code"),
        "reason_suggestions",
        ["master_type_code"],
        unique=False,
    )
    op.create_index(
        op.f("ix_reason_suggestions_normalized_key"),
        "reason_suggestions",
        ["normalized_key"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_report_requests_report_type"), "report_requests", ["report_type"], unique=False
    )
    op.create_index(
        op.f("ix_report_requests_site_code"), "report_requests", ["site_code"], unique=False
    )
